        ...
        <div className="bg-white">
          ...
          <div className="bg-gradient-to-r from-blue-900 to-blue-800 px-8 py-6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-orange-300 text-sm">Professional Profile</p>
              </div>
            </div>
          </div>
          ...
          {record.qualifications && (
            <div className="mb-8">
              ...
              {/* Footer */}
              <div className="text-center pt-6 border-t-4 border-blue-900 bg-gradient-to-r from-blue-50 to-orange-50 p-4 rounded-lg">
