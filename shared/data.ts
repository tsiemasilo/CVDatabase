...
export const DOMAINS: Domain[] = [
  { id: 1, disciplineId: 1, name: "SAP Financial Accounting and Controlling", description: "Finance and Controlling modules" },
  { id: 2, disciplineId: 1, name: "SAP Materials Management and Warehouse Management", description: "Materials Management and Warehouse Management" },
  { id: 3, disciplineId: 1, name: "SAP Sales and Distribution and Logistics Execution", description: "Sales & Distribution and Logistics Execution" },
  { id: 4, disciplineId: 1, name: "SAP Human Resources and Human Capital Management", description: "Human Resources and Human Capital Management" },
  { id: 5, disciplineId: 2, name: "SAP Advanced Business Application Programming Development", description: "SAP ABAP programming and customization" },
  { id: 6, disciplineId: 2, name: "SAP User Interface Five and Fiori Development", description: "Modern SAP user interface development" },
  { id: 7, disciplineId: 2, name: "SAP Process Integration and Cloud Platform Integration", description: "SAP system integration and middleware" },
  { id: 8, disciplineId: 3, name: "SAP Basis System Administration", description: "SAP system monitoring and maintenance" },
  { id: 9, disciplineId: 3, name: "SAP Database Administration and Performance Tuning", description: "SAP database administration and tuning" },
