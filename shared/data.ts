...
// Certificate types and names for each department
...
export const CERTIFICATE_MAPPINGS: CertificateMapping[] = [
  {
    ...
    certificateTypes: [
      {
        type: "SAP Functional Certifications",
        names: [
      ...
      {
        type: "SAP Technical Certifications",
        names: [
      ...
      },
      {
        ...
        names: [
          ...
          "SAP Certified Technology Associate - SAP HANA 2.0 SPS05 - Data Modeling",
          "SAP Certified Application Associate - SAP Business Planning and Consolidation",
          "SAP Certified Application Associate - SAP Lumira Designer"
        ]
      },
      {
        type: "SAP Project Management Certifications",
        names: [
          "SAP Certified Technology Associate - SAP Activate Project Manager",
          "SAP Certified Application Associate - SAP Solution Manager",
          "SAP Certified Technology Associate - SAP S/4HANA Project Systems",
          "SAP Certified Application Associate - SAP SuccessFactors Onboarding",
          "SAP Certified Technology Associate - SAP Landscape Management"
        ]
      }
    ]
  },
  {
    ...
    certificateTypes: [
      ...
      {
        type: "Cloud Computing Certifications",
        names: [
      ...
      {
        type: "Database & Analytics Certifications",
        names: [
          "Microsoft Certified: Azure Data Engineer Associate",
          "Oracle Database SQL Certified Associate",
          "MongoDB Certified Developer Associate",
          "Microsoft SQL Server Database Administration (MCSA)",
          "Tableau Desktop Specialist"
        ]
      },
      {
        type: "IT Service Management Certifications",
        names: [
  ...
  },
  {
    ...
    certificateTypes: [
      {
        type: "HR Management Certifications",
        names: [
      ...
      {
        type: "Talent Acquisition Certifications",
        names: [
      ...
      {
        type: "Learning & Development Certifications",
        names: [
      ...
      {
        type: "Compensation & Benefits Certifications",
        names: [
          "Certified Compensation Professional (CCP)",
          "Certified Benefits Professional (CBP)",
          "Global Remuneration Professional (GRP)",
          "Certified Employee Benefits Specialist (CEBS)",
          "WorkLife Certified Professional (WCP)"
        ]
      },
      {
        type: "Employment Law & Compliance Certifications",
        names: [
          "Professional in Human Resources International (PHRi)",
          "Certified Labor Relations Professional (CLRP)",
          "Employment Law Specialist Certificate",
          "Certified Diversity Professional (CDP)",
          "South African Board for People Practices (SABPP) Professional Registration"
        ]
      }
    ]
  },
  {
    ...
    certificateTypes: [
      {
        type: "Project Management Professional Certifications",
        names: [
      ...
      {
        type: "Agile & Scrum Certifications",
        names: [
      ...
      {
        type: "Risk & Quality Management Certifications",
        names: [
          "PMI Risk Management Professional (PMI-RMP)",
          "Certified Risk Management Professional (CRMP)",
          "Six Sigma Green Belt Certification",
          "Six Sigma Black Belt Certification",
          "ISO 9001:2015 Lead Auditor Certificate"
        ]
      },
      {
        type: "Business Analysis Certifications",
        names: [
      ...
      {
        type: "Change Management Certifications",
        names: [
          "Prosci Change Management Certification",
          "Change Management Institute Certified Change Manager",
  ...
  },
  {
    ...
    certificateTypes: [
      ...
      {
        type: "Help Desk & Customer Service Certifications",
        names: [
          "HDI Customer Service Representative (HDI-CSR)",
          "HDI Desktop Support Technician (HDI-DST)",
          "HDI Help Desk Manager (HDI-HDM)",
          "CompTIA A+ (A+)",
          "Microsoft 365 Certified: Modern Desktop Administrator Associate"
        ]
      },
      {
        type: "Technical Support Certifications",
        names: [
          "CompTIA Network+ (N+)",
          "CompTIA Security+ (Sec+)",
      ...
      {
        type: "Communication & Soft Skills Certifications",
        names: [
      ...
      {
        type: "Process Improvement Certifications",
        names: [
...
// Helper function to get certificate types for a department
export const getCertificateTypesForDepartment = (department: string): string[] => {
  const departmentMapping = CERTIFICATE_MAPPINGS.find(d => d.department === department);
  return departmentMapping ? departmentMapping.certificateTypes.map(ct => ct.type) : [];
};

// Helper function to get certificate names for a department and type
export const getCertificateNamesForType = (department: string, certificateType: string): string[] => {
  const departmentMapping = CERTIFICATE_MAPPINGS.find(d => d.department === department);
  if (!departmentMapping) return [];
  
  const typeMapping = departmentMapping.certificateTypes.find(ct => ct.type === certificateType);
  return typeMapping ? typeMapping.names : [];
};